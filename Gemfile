...
# json 3 removed the quirks_mode keyword that ActiveSupport 6.1 passes to
# JSON.generate (active_support/json/encoding.rb:110), so anything rendering
# JSON - including Rails' own cookie middleware - raises ArgumentError. The
# stores lock 2.5.1 and 2.6.3.
gem "json", "< 3"
